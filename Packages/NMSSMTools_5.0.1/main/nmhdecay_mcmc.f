...
*   Check for errors
 ...
 29   ERR=0
      ...
      IF(XDEV.EQ.1d99)THEN
       WRITE(0,1)"X_dev MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(LCEN.EQ.1d99)THEN
       WRITE(0,1)"LAMBDA_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(TBCEN.EQ.1d99)THEN
       WRITE(0,1)"TANB_cen MUST BE GIVEN IN BLOCK MINPAR"
       ERR=1
      ENDIF

      IF(MUCEN.EQ.1d99)THEN
       WRITE(0,1)"MUEFF_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(M1CEN.EQ.1d99 .AND. M1DEV.NE.1d99)THEN
       WRITE(0,1)"M1_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(M2CEN.EQ.1d99)THEN
       WRITE(0,1)"M2_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(M3CEN.EQ.1d99 .AND. M3DEV.NE.1d99)THEN
       WRITE(0,1)"M3_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(AQCEN.EQ.1d99)THEN
       WRITE(0,1)"AU3_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
      ...
      IF(MQCEN.EQ.1d99)THEN
       WRITE(0,1)"MQ3_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
      ...
      IF(MACEN.EQ.1d99 .AND. MADEV.NE.1d99)THEN
       WRITE(0,1)"MA_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(MPCEN.EQ.1d99 .AND. MPDEV.NE.1d99)THEN
       WRITE(0,1)"MP_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(ALCEN.EQ.1d99 .AND. ALDEV.NE.1d99)THEN
       WRITE(0,1)"AL_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(AKCEN.EQ.1d99 .AND. AKDEV.NE.1d99)THEN
       WRITE(0,1)"AK_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(XIFCEN.EQ.1d99 .AND. XIFDEV.NE.1d99)THEN
       WRITE(0,1)"XIF_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF

      IF(XISCEN.EQ.1d99 .AND. XISDEV.NE.1d99)THEN
       WRITE(0,1)"XIS_cen MUST BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
...
*   Relations between (ALAMBDA, MA, XIF) and (AKAPPA, MP, XIS)
     ...
     . " CAN BE GIVEN IN BLOCK EXTPAR"
      ...
      IF(KCEN.EQ.0d0)THEN
       IF(AKCEN.NE.0d0 .AND. AKCEN.NE.1d99)THEN
