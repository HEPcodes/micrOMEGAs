...
*********************************************************************
      ...
      DOUBLE PRECISION OMG,OMGMIN,OMGMAX,XSMAX
     ...
     .       DMK,DMKmin,DMKmax,epsK,epsKmin,epsKmax
      ...
      DOUBLE PRECISION PandaX,LUX_SI,LUX_SDn,LUX_SDp,PICO2L,PICO60
     ...
     .      x,dNdx,EMIN,NBIN
      ...
      WRITE(17,900) 2,"5.0.1      # Version number"
     ...
     .      "# Lightest neutralino is not the LSP in micrOMEGAs"
      ...
      IF(IABS(OMGFLAG).EQ.2 .OR. IABS(OMGFLAG).EQ.4)THEN
        XSMAX=MIN(PandaX(DABS(MNEU(1))),LUX_SI(DABS(MNEU(1))))
	...
	ENDIF
        ...
        XSMAX=MIN(LUX_SDp(DABS(MNEU(1))),PICO60(DABS(MNEU(1))),
     .  PICO2L(DABS(MNEU(1))))
        IF(XSMAX.EQ.1d99)THEN
...
*  From IF(OUTFLAG.NE.1)
      ...
      WRITE(18,900) 2,"5.0.1      # Version number"
     ...
     . 'BR(t -> ~t_2 ~chi_50)'
      ...
      WRITE(19,900) 2,"5.0.1      # Version number"
      IF(PROB(30).GT.0d0)
