...
are automatically written by \micro. A file containing the instructions to call  \smodels\ can be found in \verb|\micro\_4.3/include/SMODELS.inc| (or \verb|SMODELS.inc_f|).
