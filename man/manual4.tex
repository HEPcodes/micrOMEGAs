...
{\Large\bf The  micrOMEGAs user's manual, version 4.2} \\[8mm]
...
Parameters  {\it Qren} and  {\it Qfac} define the renormalisation and factorization
...
section for
\begin{verbatim}
  proton, [a]proton -> pName1, pName1, jet
\end{verbatim} 
...
\noindent
$\bullet$ \verb|basicSpectra(pdgN, Mass,  outN,Spectr)|\\
...
\bibitem{Belanger:2014bga}
  G.~Bélanger, K.~Kannike, A.~Pukhov and M.~Raidal,
